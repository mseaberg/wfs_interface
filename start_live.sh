...
#command+="export PYTHONPATH=$PYTHONPATH:/reg/neh/home/seaberg/Python/lcls_beamline_toolbox;"
#command+="cd /reg/neh/home/seaberg/WFS_interface;"
#command+="hostname;"
#command+="mpirun -n 8 python mpi_reply.py -b $2 -e $3 -r $4 -s $5 -c $6 -l True'"

#xterm -e command
xterm -e "ssh $1 'source /reg/g/psdm/etc/psconda.sh; cd Python/wfs_interface; hostname; mpirun -n 8 python mpi_reply.py -b $2 -e $3 -r $4 -s $5 -c $6 -l True'"
